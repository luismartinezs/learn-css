Note: the code in this folder was copied from here: https://github.com/css-modules/webpack-demo
It illustrates the concept and code structure of a project using CSS modules
